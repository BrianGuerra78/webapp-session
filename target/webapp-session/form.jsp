...
import="java.util.*,java.time.format.*,org.bguerra.apiservlet.webapp.headers.models.*"%>
<%
    ...
    <div>
        ...
        <div>
            <select name="categoria" id="categoria">
                ...
                <option value="<%=c.getId().equals(producto.getCategoria().getId())? "selected" : ""%>"><%=c.getNombre()%></option>
                <%}%>
            </select>
        </div>
